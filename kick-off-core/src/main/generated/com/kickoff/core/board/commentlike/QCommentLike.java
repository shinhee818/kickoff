...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = 501562137L;
    ...
    public final com.kickoff.core.board.postcomment.QPostComment postComment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.postComment = inits.isInitialized("postComment") ? new com.kickoff.core.board.postcomment.QPostComment(forProperty("postComment"), inits.get("postComment")) : null;
    }
